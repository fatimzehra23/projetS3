...
public class DAOFactory {
    private static final String PROPERTIES_FILE = "technicien_fct/dao.properties";
    ...
    public TechnicienFctDAO getTechnicienDAO() {
        return new TechnicienFctDaoImpl(this);
    }
    
    public DisponibiliteDAO getDisponibiliteDAO() {
        return new DisponibiliteDAOImpl(this);
    }
}
