...
public class ReclamationBean {
    ...
    public ReclamationBean(int idRecl, String sujet, String description, java.util.Date dateCreation, String email, String batiment, String etage, int numChambre) {
        this.idRecl = idRecl;
        this.sujet = sujet;
