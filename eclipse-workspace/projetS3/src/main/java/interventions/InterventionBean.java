...
public class InterventionBean {
    ...
    public InterventionBean(String priority, int idInterv, String description, Date dateCreation, Date dateTerminaison, String nomTech, String statut, String batiment, String etage, int numChambre, String email, int evaluation, String commentaire) {
